...
import { Search, ChevronDown, Building2, Phone, Clock } from 'lucide-react';
        ...
        >
          ...
          <div
            className={`relative w-12 h-6 rounded-full transition-colors ${
              campaignActive ? 'bg-[#00E676]' : 'bg-[#FF3D00]'
            }`}
          >
            <motion.div
          ...
          >
            ...
            <div className="relative flex gap-3">
              <div className="flex-shrink-0">
                ...
                <div
                  className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-[#1E2A3A] ${
